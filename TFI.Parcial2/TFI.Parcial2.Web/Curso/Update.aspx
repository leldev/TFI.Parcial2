<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="TFI.Parcial2.Web.Curso.Update" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblTitle" runat="server" Text="Modificar Curso" CssClass="display-4 text-uppercase" />
    <br />
    <br />
    ...
    <asp:Panel ID="PnlMain" runat="server" CssClass="jumbotron">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md col-sm-12">
                ...
                <asp:HiddenField ID="FldFechaLimite" runat="server" />
        ...
        <div class="form-row">
            <asp:Button ID="BtnUpdate" runat="server" Text="Modificar" OnClick="BtnUpdate_Click" CssClass="btn btn-light" />
        </div>
    </asp:Panel>
    <script type="text/javascript">
        ready(() => {
            ...
            //
            let txt = document.getElementById("<%= this.TxtFechaLimite.ClientID %>");
            let label = document.getElementById("<%= this.FldFechaLimite.ClientID %>");
